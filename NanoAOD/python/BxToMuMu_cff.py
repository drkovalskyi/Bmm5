...
kinematic_pset = cms.PSet(
    ...
    kin_alpha2   = Var("userFloat('kin_alpha2')",      float, doc = "Kinematic fit: pointing angle in 3D wrt PV2"),
    kin_alpha2Err = Var("userFloat('kin_alpha2Err')",  float, doc = "Kinematic fit: pointing angle uncertainty in 3D wrt PV2"),
    ...
    kin_tau2     = Var("userFloat('kin_tau2')",        float, doc = "Kinematic fit: decay time wrt Primary Vertex 2 in 3D"),
    ...
    kin_pvIndex   = Var("userInt('kin_pvIndex')",        int, doc = "Kinematic fit: best primary vertex index"),
    kin_pv2Index  = Var("userInt('kin_pv2Index')",       int, doc = "Kinematic fit: second best primary vertex index"),
)
...
BxToMuMuDiMuonMcTableVariables = merge_psets(
    ...
    cms.PSet(
        ...
        gen_pvIndex    = Var("userInt(  'gen_pvIndex')",      int,   doc = "Gen match: primary vertex"),
