...
reco::Track bmm::makeRecoTrack(const Run3ScoutingTrack& sTrack) {
...
reco::Track bmm::makeRecoTrack(const Run3ScoutingMuon& sMuon) {
...
Run3ScoutingTrack bmm::makeScoutingTrack(const reco::Track& trk) {
...
pat::Muon bmm::makePatMuon(const Run3ScoutingMuon& sMuon) {
...
reco::Vertex bmm::makeRecoVertex(const Run3ScoutingVertex& sVertex) {
