...
data_path3 = "/eos/cms/store/group/phys_bphys/bmm/bmm6/PostProcessing/Skims/531/trig/"
...
samples = {
    ...
    # },
    # 'ParkingDoubleMu_2022C': {
    #     'datasets': [
    #         data_path3 + '/ParkingDoubleMuonLowMass0+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass1+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass2+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass3+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass4+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass5+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass6+Run2022C-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass7+Run2022C-PromptReco-v1+MINIAOD/',
    #     ],
    #     'save_triggers': ["HLT_Mu4_L1DoubleMu"],
    #     'all_triggers_are_safe': False,
    # },
    # 'ParkingDoubleMu_2022D': {
    #     'datasets': [
    #         data_path3 + '/ParkingDoubleMuonLowMass0+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass1+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass2+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass3+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass4+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass5+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass6+Run2022D-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass7+Run2022D-PromptReco-v1+MINIAOD/',
    #     ],
    #     'save_triggers': ["HLT_Mu4_L1DoubleMu"],
    #     'all_triggers_are_safe': False,
    # },
    # 'ParkingDoubleMu_2022E': {
    #     'datasets': [
    #         data_path3 + '/ParkingDoubleMuonLowMass0+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass1+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass2+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass3+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass4+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass5+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass6+Run2022E-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass7+Run2022E-PromptReco-v1+MINIAOD/',
    #     ],
    #     'save_triggers': ["HLT_Mu4_L1DoubleMu"],
    #     'all_triggers_are_safe': False,
    # },
    # 'ParkingDoubleMu_2022F': {
    #     'datasets': [
    #         data_path3 + '/ParkingDoubleMuonLowMass0+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass1+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass2+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass3+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass4+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass5+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass6+Run2022F-PromptReco-v1+MINIAOD/',
    #         data_path3 + '/ParkingDoubleMuonLowMass7+Run2022F-PromptReco-v1+MINIAOD/',
    #     ],
    #     'save_triggers': ["HLT_Mu4_L1DoubleMu"],
    #     'all_triggers_are_safe': False,
    # },
    'ParkingDoubleMu_2022': {
        'datasets': [
            data_path3 + '/ParkingDoubleMuonLowMass0+Run2022C-PromptReco-v1+MINIAOD/',
            data_path3 + '/ParkingDoubleMuonLowMass1+Run2022C-PromptReco-v1+MINIAOD/',
            data_path3 + '/ParkingDoubleMuonLowMass2+Run2022C-PromptReco-v1+MINIAOD/',
    ...
    'ParkingDoubleMu_2023': {
        'datasets': [
            data_path3 + '/ParkingDoubleMuonLowMass0+Run2023C-PromptReco-v1+MINIAOD/',
            data_path3 + '/ParkingDoubleMuonLowMass1+Run2023C-PromptReco-v1+MINIAOD/',
            data_path3 + '/ParkingDoubleMuonLowMass0+Run2023C-PromptReco-v2+MINIAOD/',
        ],
        'save_triggers': ["HLT_Mu4_L1DoubleMu"],
        'all_triggers_are_safe': False,
    },
    'ParkingDoubleMu_2024': {
        'datasets': [
            data_path3 + '/ParkingDoubleMuonLowMass0+Run2024C-PromptReco-v1+MINIAOD/',
    ...
    # 'Ksmm': {
    #     'datasets': [
    #         data_path2 + "/K0sToMuMu_K0sFilter_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v15_ext1-v2+MINIAODSIM/",
    #     ],
    #     'save_triggers': [],
    #     'all_triggers_are_safe': True,
    # },
    'BdToJpsiKstar': {
        'datasets': [
            data_path2 + "/BdToJpsiKstar_BMuonFilter_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2+MINIAODSIM/",
        ],
        'save_triggers': [],
        'all_triggers_are_safe': True,
    },
