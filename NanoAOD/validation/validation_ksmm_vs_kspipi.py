...
output_path = "/eos/home-d/dmytro/www/plots/ksmm/MVA_input_ksmm_vs_kspipi/"

histos = defaultdict(dict)

def book_histos(rdf, h_name, line_color=ROOT.kBlack, fill_color=None):
...
chain2 = ROOT.TChain("kspipiMc")
chain2.Add(f"{input_path}/kspipi/K0sToPiPi_K0sFilter_TuneCP5_13p6TeV_pythia8-evtgen/*.root")
rdf2 = ROOT.RDataFrame(chain2)
n2 = book_histos(rdf2, "K_{S}#rightarrow#pi#pi")
print(f"n2: {n2}")
