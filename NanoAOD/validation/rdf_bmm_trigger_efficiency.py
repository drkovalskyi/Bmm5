...
# max_files = 10
max_files = 999999
sample_names = ["BsToMuMu", "ParkingDoubleMuonLowMass", "Muon", "ZeroBias",
                "EGamma", "HLTPhysics"]
...
def process_sample(sample, era):
    ...
    rdf = rdf.Define("cands", "mm_mu1_index>=0 && mm_mu2_index>=0 && "
                     ...
                     "abs(mm_kin_mass-5.4)<0.5 && mm_kin_vtx_prob>0.01")
...
def print_results(run):
    ...
    eff_report = {
        "Absolute efficiency": {
            "Data": {},
            "MC": {
                "BsToMuMu": get_efficiency(report["BsToMuMu"]["HLT_DoubleMu4_3_LowMass"],
                                            report["BsToMuMu"]["All"]),
            }
        },
        "Absolute HLT efficiency": {
            "Data": {},
            "MC": {
                "BsToMuMu": get_efficiency(report["BsToMuMu"]["L1_DoubleMu_Mix_Unprescaled&&HLT_DoubleMu4_3_LowMass"],
                                            report["BsToMuMu"]["L1_DoubleMu_Mix_Unprescaled"]),
            }
        },
        "Relative HLT efficiency": {
            "Data": {},
            "MC": {
                "BsToMuMu": get_efficiency(report["BsToMuMu"]["HLT_Mu4_L1DoubleMu&&HLT_DoubleMu4_3_LowMass"],
                                            report["BsToMuMu"]["HLT_Mu4_L1DoubleMu"]),
            }
        },
        "Absolute L1 efficiency": {
            "Data": {},
            "MC": {
                "BsToMuMu": get_efficiency(report["BsToMuMu"]["L1_DoubleMu_Mix_Unprescaled"],
                                            report["BsToMuMu"]["All"]),
            }
        },
        "Relative L1 efficiency": {
            "Data": {},
            "MC": {
                "BsToMuMu": get_efficiency(report["BsToMuMu"]["HLT_Mu8&&HLT_Mu0_L1DoubleMu"],
                                            report["BsToMuMu"]["HLT_Mu8"]),
            }
        },
...
samples["BsToMuMu"]["files"]["Run3Summer22"].append(
    path + "/BsToMuMu_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer22MiniAODv4-130X_mcRun3_2022_realistic_v5-v2+MINIAODSIM/*.root"
)
samples["BsToMuMu"]["files"]["Run3Summer22EE"].append(
    path + "/BsToMuMu_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2+MINIAODSIM/*.root"
)
samples["BsToMuMu"]["files"]["Run3Summer23"].append(
    path + "/BsToMuMu_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v14-v3+MINIAODSIM/*.root"
)
samples["BsToMuMu"]["files"]["Run3Summer23BPix"].append(
    path + "/BsToMuMu_SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v3+MINIAODSIM/*.root"
)
samples["BsToMuMu"]["files"]["RunIII2024Summer24"].append(
    path + "/BsToMuMu_Par-SoftQCDnonD_TuneCP5_13p6TeV_pythia8-evtgen+RunIII2024Summer24MiniAOD-140X_mcRun3_2024_realistic_v26-v2+MINIAODSIM/*.root"
)
